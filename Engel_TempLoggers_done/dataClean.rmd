...
rbind(LongPineNumber3_2015, LongPineNumber3_2016, LongPineNumber3_2016_2) -> LongPineNumber3
...
#Long Pine Hidden Paradise
LongPineHiddenParadise_2017 <- read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/Data/ReadyforR/LongPineHiddenParadise_2017.csv", col_names = TRUE, na = "NA")

select(LongPineHiddenParadise_2017, c(1:4)) -> LongPineHiddenParadise

LongPineHiddenParadise %>% 
  select(c(1:4)) %>% 
  separate(DateTime, c("Date", "Time"), sep = " ") %>% 
  mutate(Stream = "Long Pine Creek",
         Site = "Hidden Paradise",
         Date = lubridate::mdy(Date),
         Month = lubridate::month(Date),
         Year = lubridate::year(Date),
         Day = lubridate::day(Date),
         ...
         Deployment = "Year-round") %>% 
  select(-ID) %>% 
  select(-Location) -> LongPineHiddenParadise

LongPineHiddenParadise[c(4,5,1,7,6,8,2,3,9,10,11,12,13,14)] -> LongPineHiddenParadise

#Long Pine Number 4

LongPineNumber4_2015 <- read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/Data/ReadyforR/LongPineNumber4_2015.csv", col_names = TRUE, na = "NA")

select(LongPineNumber4_2015, c(1:4)) -> LongPineNumber4_2015

LongPineNumber4_2016 <- read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/Data/ReadyforR/LongPineNumber4_2016.csv", col_names = TRUE, na = "NA")

select(LongPineNumber4_2016, c(1:4)) -> LongPineNumber4_2016

LongPineNumber4_2017 <- read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/Data/ReadyforR/LongPineNumber4_2017.csv", col_names = TRUE, na = "NA")

select(LongPineNumber4_2017, c(1:4)) -> LongPineNumber4_2017

LongPineNumber4_2017_2 <- read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/Data/ReadyforR/LongPineNumber4_2017_2.csv", col_names = TRUE, na = "NA")

select(LongPineNumber4_2017_2, c(1:4)) -> LongPineNumber4_2017_2

rbind(LongPineNumber4_2015, LongPineNumber4_2016, LongPineNumber4_2017, LongPineNumber4_2017_2) -> LongPineNumber4
...
LongPineNumber4 %>% 
  ...
  mutate(Stream = "Long Pine Creek",
         ...
         Deployment = "Year-round") %>% 
  select(-ID) %>% 
  select(-Location) -> LongPineNumber4

LongPineNumber4[c(4,5,1,7,6,8,2,3,9,10,11,12,13,14)] -> LongPineNumber4

rbind(LongPineNumber1, LongPineNumber2, LongPineNumber3, LongPineNumber4, LongPineHiddenParadise) -> LongPineMaster
...
#Nine Mile Creek Lower
NineMileCreekLower_2017 <-read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/Data/ReadyforR/NineMileCreekLower_2017.csv", col_names = TRUE, na = "NA")

select(NineMileCreekLower_2017, c(1:4)) -> NineMileCreekLower_2017

NineMileCreekLower_2017 %>% 
  select(c(1:4)) %>% 
  separate(DateTime, c("Date", "Time"), sep = " ") %>% 
  mutate(Stream = "Nine Mile Creek",
         Site = "Lower",
         ...
         Deployment = "Year-round") %>% 
  select(-ID) %>% 
  select(-Location) -> NineMileCreekLower

NineMileCreekLower[c(4,5,1,7,6,8,2,3,9,10,11,12,13,14)] -> NineMileCreekLower
```
...
#Willow Creek
WillowNumber1_2015 <-read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/Data/ReadyforR/WillowNumber1_2015.csv", col_names = TRUE, na = "NA")

select(WillowNumber1_2015, c(1:4)) -> WillowNumber1_2015

WillowNumber1_2016 <- read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/Data/ReadyforR/WillowNumber1_2016.csv", col_names = TRUE, na = "NA")

select(WillowNumber1_2016, c(1:4)) -> WillowNumber1_2016

rbind(WillowNumber1_2015, WillowNumber1_2016) -> WillowCreekNumber1

WillowCreekNumber1 %>% 
  select(c(1:4)) %>% 
  separate(DateTime, c("Date", "Time"), sep = " ") %>% 
  mutate(Stream = "Willow Creek",
         Site = "#1 Camp Witness",
         Date = lubridate::mdy(Date),
         Month = lubridate::month(Date),
         Year = lubridate::year(Date),
         ...
         Deployment = "Year-round") %>% 
  select(-ID) %>% 
  select(-Location) -> WillowCreekNumber1

WillowCreekNumber1[c(4,5,1,7,6,8,2,3,9,10,11,12,13,14)] -> WillowCreekNumber1
```
...
#681637 obs. of 14 vars
# rbind(MasterData,
      # LongPineMaster) -> MasterData

#723450 obs. of 14 vars
# rbind(MasterData,
#       NineMileCreekLower,
#       WillowCreekNumber1) -> MasterData
...
file_path_new <- file.path("C:/Users/alex.engel/Documents/GitHub/templogger/ArchivalMasterFiles")
   setwd(file_path_new)
   
 now <- Sys.time()
   file_name <- paste0(format(now, "%m%d%Y_%H%M%S_"), "MasterData.csv")
...
# MasterData %>%
#   filter(Stream == "White River") -> WhiteRiver
# 
# MasterData %>% 
#   filter(Stream == "Nine Mile Creek") -> NineMile
...
#Error check
Check for errors in Master Data vs. Archival data

```{r}
ArchiveData <- read_csv("C:/Users/alex.engel/Documents/GitHub/templogger/ArchivalMasterFiles/01202021_173037_MasterData.csv", col_names = TRUE, na = "NA")

ArchiveData %>% 
  select(-X1) -> ArchiveData


ArchiveData %>% 
  select(c(Stream,TempC)) -> streamArch

MasterData %>% 
  select(c(Stream,TempC)) -> streamMast

streamArch == streamMast

ArchiveData == MasterData
```
